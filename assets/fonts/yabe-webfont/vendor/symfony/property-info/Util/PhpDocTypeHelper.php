...
use _YabeWebfont\phpDocumentor\Reflection\PseudoTypes\ConstExpression;
use _YabeWebfont\phpDocumentor\Reflection\PseudoTypes\List_;
use _YabeWebfont\phpDocumentor\Reflection\Type as DocType;
use _YabeWebfont\phpDocumentor\Reflection\Types\Array_;
use _YabeWebfont\phpDocumentor\Reflection\Types\Collection;
use _YabeWebfont\phpDocumentor\Reflection\Types\Compound;
use _YabeWebfont\phpDocumentor\Reflection\Types\Null_;
use _YabeWebfont\phpDocumentor\Reflection\Types\Nullable;
...
final class PhpDocTypeHelper
{
    ...
    private function createType(DocType $type, bool $nullable, ?string $docType = null) : ?Type
    {
        ...
        if ($type instanceof Collection) {
            ...
            return new Type($phpType, $nullable, $class, \true, $keys, $values);
        }
        // Cannot guess
