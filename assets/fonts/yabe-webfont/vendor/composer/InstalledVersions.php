 ...
 */
namespace _YabeWebfont\Composer;

use _YabeWebfont\Composer\Autoload\ClassLoader;
use _YabeWebfont\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_YabeWebfont\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
